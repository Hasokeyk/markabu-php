<?php
	...
	class MarkabulMarketplaceProducts{
		...
		public function get_product_comment($barcode = null){
			...
			if($barcode != null){
				...
				if(isset($product_info->content[0])){
                    ...
                    $url                = 'https://public-mdc.markabul.com/discovery-web-socialgw-service/api/review/'.$product_content_id.'?merchantId='.$this->supplierId.'&storefrontId=1&culture=tr-TR&order=5&searchValue=&onlySellerReviews=true&ratingValues[]=5&page=0';
